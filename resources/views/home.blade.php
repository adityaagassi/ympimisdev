        ...
        <div class="col-md-4">
            <div class="box box-default box-solid">
                ...
                <div class="box-body">
                    ...
                    <span style="font-weight: bold; color: red;"><i class="fa fa-caret-right"></i> Vendor To YMPI (ベンダー⇒YMPI)</span>
                    ...
                    <span style="font-weight: bold; color: red;"><i class="fa fa-caret-right"></i> Warehouse To Production (YMPI 部品倉庫⇒生産職場)</span>
        ...
        <div class="col-md-4">
            <div class="box box-default box-solid">
                ...
                <div class="box-body">
                    ...
                    <span style="font-weight: bold; color: red;"><i class="fa fa-caret-right"></i> WIP Monitoring (WIP 生産工程モニタリング)</span>
                    ...
                    <span style="font-weight: bold; color: red;"><i class="fa fa-caret-right"></i> WIP Performance (WIPパフォーマンス)</span>
        ...
        <div class="col-md-4">
            <div class="box box-default box-solid">
                ...
                <div class="box-body">
                    ...
                    <span style="font-weight: bold; color: red;"><i class="fa fa-caret-right"></i> Sales Control (売上管理)</span>
                    ...
                    <span style="font-weight: bold; color: red;"><i class="fa fa-caret-right"></i> Finished Goods Control (完成品管理)</span>
                    ...
                    <span style="font-weight: bold; color: red;"><i class="fa fa-caret-right"></i> Shipment Control (出荷管理)</span>
                    ...
                    <span style="font-weight: bold; color: red;"><i class="fa fa-caret-right"></i> Shipment Performance (出荷管理)</span>
