...
<section class="content">
	<div class="row">
		<div class="col-xs-12" style="text-align: center;margin-bottom: 10px">
			<h3 class="box-title" style="color: white;margin-top: 10px;font-size: 28px;font-weight: bold;background-color: purple;padding: 10px">List Patrol<span class="text-purple"></span></h3>
		</div>
		...
		<div class="col-xs-5" style="text-align: center;">
			...
			<a href="{{ url('index/audit_patrol_mis') }}" class="btn btn-default btn-block" style="font-size: 24px; border-color: green;">Audit MIS (MIS課内部監査)</a>
			<!-- <hr style="border: 1px solid red"> -->
