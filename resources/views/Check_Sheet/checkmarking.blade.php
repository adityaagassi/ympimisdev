                ...
                <tbody>
                  <tr>
                   ...
                   <td style="background-color: rgb(204, 255, 255);">
                    ...
                    <select id="theSelect{{$nomor + 1}}" onchange="check2('{{$nomor + 1}}','{{$detail->id}}');okbara({{$nomor + 1}}); masuk('0','{{$detail->id}}')" class="form-control select2">
                    </select>
                    @else
                    <select id="theSelect{{$nomor + 1}}" onchange="check('{{$nomor + 1}}','{{$detail->id}}'); hide({{$nomor + 1}}); update({{$nomor + 1}},{{$detail->id}})" class="form-control select2">
                    </select>
                    @endif
                  </td>
                  <td style="background-color: rgb(255, 204, 255);">
                    @if( $detail->package_set == "-")
                    <select id="theSelectun{{$nomor + 1}}" onchange="uncheck2('{{$nomor + 1}}','{{$detail->id}}');ngbara({{$nomor + 1}});  masuk('1','{{$detail->id}}')" class="form-control select2">
                      <option value="" >Uncheck</option>
                    </select>
                    @else
                    <select id="theSelectun{{$nomor + 1}}" onchange="uncheck('{{$nomor + 1}}','{{$detail->id}}');hide({{$nomor + 1}}); update({{$nomor + 1}},{{$detail->id}})" class="form-control select2">
                      <option value="" >Uncheck</option>
                    </select>
                    @endif
                  </td>
