...
<section class="content">
  ...
  <div class="nav-tabs-custom">
              ...
              <tbody>
                <tr>
                 ...
                 <td>
                  ...
                  <button class="btn btn-block btn-primary btn-sm" id="like{{$nomor + 1}}" onclick="add({{$nomor + 1}}); minusdata({{$nomor + 1}}); hide({{$nomor + 1}}); update({{$nomor + 1}},{{$detail->id}});" style="display: none;"> Check</button>
                   @else
                 ...
                 <td>
                  @if( $detail->package_set == "-")
                  <button class="btn btn-block btn-warning btn-sm" id="like{{$nomor + 1}}" onclick="minus({{$nomor + 1}}); minusdata({{$nomor + 1}}); hide({{$nomor + 1}}); update({{$nomor + 1}},{{$detail->id}});" style="display: none;"> Uncheck</button>
                   @else
    ...
    function save(){
      ...
      //   id:id,
      // }
      // $.post('{{ url("save/CheckSheet") }}', data, function(result, status, xhr){
      //   console.log(status);
      //   console.log(result);
      //   console.log(xhr);
      // });
