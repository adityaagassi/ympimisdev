      ...
      <div class="box-body">
        <table class="table" style="border: 1px solid black;">
            ...
            <tr>
              ...
              <th colspan="8" style="text-align: center; vertical-align: middle;font-size: 18px;font-weight: bold">Form Laporan Ketidaksesuaian Material</th>
              @if((Auth::user()->username == $cpar->chief || Auth::user()->role_code == "MIS") && $cpar->approvalcf == null && $cpar->posisi == "cf")
              <th colspan="2" style="border: 1px solid black;vertical-align: middle;"><center>Approval</center></th>
              @elseif((Auth::user()->username == $cpar->manager || Auth::user()->role_code == "MIS") && $cpar->approvalm == null && $cpar->posisi == "m")
              <th colspan="2" style="border: 1px solid black;vertical-align: middle;"><center>Approval</center></th>
              @endif
            </tr>
          </thead>
          <tbody>
            <form role="form" method="post" action="{{url('index/cpar/approval/'.$cpar->id)}}">
            <tr>
            ...
            <tr>
              <td colspan="2" style="border:none;width: 25%">Subject</td>
            ...
            <tr>
              ...
              <td colspan="2" rowspan="3" style="border: 1px solid black;vertical-align: middle;padding: 0">
                <center>
                  ...
                  <br><br><a data-toggle="modal" data-target="#notapproved{{$cpar->id}}" class="btn btn-danger" href="" style="font-weight: bold; ">Reject CPAR</a>
                </center>
              </td>
        ...
        <!-- <div class="col-sm-12">
          ...
          <a data-toggle="modal" data-target="#notapproved{{$cpar->id}}" class="btn btn-danger col-sm-12" href="" style="width: 100%; font-weight: bold; font-size: 20px;margin-top: 10px">Reject CPAR</a>          
  ...
  <div class="modal modal-danger fade" id="notapproved{{$cpar->id}}" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <form role="form" method="post" action="{{url('index/cpar/notapprove/'.$cpar->id)}}">
