...
<section class="content" style="padding-top: 0;">
	...
	<div class="row">
		...
		<div class="col-xs-12" id="picking">
			...
			<div class="col-xs-2">
				<a href="{{ url("index/final/reed_synthetic") }}" class="btn btn-info" style="width: 100%; font-size: 1vw; font-weight: bold;"><i class="fa fa-arrow-left"></i> Ke Halaman Packing</a>
			</div>
