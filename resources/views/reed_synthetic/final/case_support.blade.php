...
<section class="content" style="padding-top: 0;">
	...
	<div class="row">
		...
		<div id="main">
				...
				<center>
					...
					<div class="col-xs-12" style="padding: 0px; margin-bottom: 5%;">
						<div style="background-color: #CE93D8;">
							<span style="font-weight: bold; color: rgb(60,60,60); font-size: 2vw;">3. SCAN REED CASE 1</span><br>
						</div>
					...
					<div class="col-xs-12" style="padding: 0px; margin-bottom: 5%;">
						<div style="background-color: #CE93D8;">
							<span style="font-weight: bold; color: rgb(60,60,60); font-size: 2vw;">4. SCAN REED CASE 2</span><br>
						</div>
			...
			<div class="col-xs-9" style="margin-top: 5%;">
					...
					<div class="modal-body table-responsive no-padding">
						<div class="form-group">
							<div style="background-color: #7eca9c;">
								<center>
									<h3>SUPPORT PAPER & REED CASE VERIFICATION</h3>
								</center>
							</div>
	...
	<script>
		...
		$('#support_paper').keydown(function(event) {
			if (event.keyCode == 13 || event.keyCode == 9) {
				if($("#support_paper").val().length == 7){
					...
					$('#support_paper').prop('readonly', true);
		...
		function scanPacking() {
			...
			var reed_case1 = $("#reed_case1").val();
			var reed_case2 = $("#reed_case2").val();

			if(order_id == '' || support_paper == '' || reed_case1 == '' || reed_case2 == ''){
			...
			var data = {
				...
				reed_case1 : reed_case1,
				reed_case2 : reed_case2
			}
