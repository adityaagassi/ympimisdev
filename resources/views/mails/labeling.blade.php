...
<body>
	...
	<div>
		<center>
			...
			<p style="font-size: 18px;">Labeling Safety Sign Mesin Berputar of {{ $leader }} ({{ $department_name }}) {{ $activity_name }} <br>on {{ $monthTitle }} <br> (Last Update: {{ date('d-M-Y H:i:s') }})</p>
			...
			<a href="http://172.17.128.4/mirai/public/index/labeling/print_labeling_email/{{ $activity_list_id }}/{{ $month }}">See Daily Check FG Data / Approval Data</a><br>
