...
<body>
	<div>
		<center>
			...
			<br>
			<span style="font-weight: bold; background-color: orange;">&#8650; <i>Klik disini untuk Melihat Monitoring</i> &#8650;</span><br>
			<a href="{{ url('index/audit_patrol_monitoring/stocktaking') }}">Response atau Penanganan Audit Stocktaking</a><br>
			...
			<br>
			<span style="font-weight: bold; background-color: orange;">&#8650; <i>Klik disini untuk Melihat Monitoring</i> &#8650;</span><br>
			<a href="{{ url('index/audit_patrol_monitoring/mis') }}">Response atau Penanganan Audit MIS</a><br>
