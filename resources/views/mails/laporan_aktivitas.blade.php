...
<body>
	...
	<div>
		<center>
			...
			<p style="font-size: 18px;">{{ $activity_name }} of {{ $leader }} ({{ $department_name }}) <br>on {{ $month }}<br>Section {{ $section }}<br>Sub Section {{ $subsection }} <br> (Last Update: {{ date('d-M-Y H:i:s') }})</p>
