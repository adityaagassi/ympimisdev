...
<body>
	...
	<div>
		<center>
			...
			<a href="http://172.17.128.4/mirai/public/index/audit_report_activity/print_audit_report_email/{{ $activity_list_id }}/{{ substr($date,0,7) }}">See Audit Report Activity Data / Approval Data</a>
		</center>
	</div>
</body>
</html>