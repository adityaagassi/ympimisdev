...
<body>
	<div>
		<center>
			...
			<br><!-- 
			<span style="font-weight: bold; background-color: orange;">&#8650; <i>Klik disini untuk</i> &#8650;</span><br>
			<a href="http://172.17.128.4/mirai/public/purchase_requisition/verifikasi/{{ $id }}">Approval PR</a><br> -->

			<br>
			<span style="font-weight: bold;"><i>Apakah anda ingin menyetujui PR ini ?</i></span><br>
			@if($posisi == "manager")
			<a style="background-color: green; width: 50px;" href="{{ url("purchase_requisition/approvemanager/".$id) }}">&nbsp;&nbsp;&nbsp; Ya &nbsp;&nbsp;&nbsp;</a>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			@elseif($posisi == "dgm")
			<a style="background-color: green; width: 50px;" href="{{ url("purchase_requisition/approvedgm/".$id) }}">&nbsp;&nbsp;&nbsp; Ya &nbsp;&nbsp;&nbsp;</a>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			@endif
			...
			<br>
			<span style="font-weight: bold;"><i>Apakah anda ingin menyetujui PR ini ?</i></span><br>
			<a style="background-color: green; width: 50px;" href="{{ url("purchase_requisition/approvegm/".$id) }}">&nbsp;&nbsp;&nbsp; Ya &nbsp;&nbsp;&nbsp;</a>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<a style="background-color: orange; width: 50px;" href="{{ url("purchase_requisition/reject/".$id) }}">&nbsp; Tidak &nbsp;</a><br>
