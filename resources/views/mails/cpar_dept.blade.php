...
<body>
	<div>
		<center>
			...
			<p style="font-size: 18px;">Penerbitan CPAR ANTAR DEPARTEMEN<br>(Last Update: {{ date('d-M-Y H:i:s') }})</p>
			...
			<a href="http://172.17.128.4/mirai/public/index/cpar/verifikasicpar/{{ $id }}">CPAR Verification</a><br>
