...
<body>
	<div>
		<center>
			...
			@if($posisi == "bagian")
				<a href="http://172.17.128.87/miraidev/public/index/qc_car/detail/{{$id_car}}">See CAR Data</a><br>
			@else
				<a href="http://172.17.128.87/miraidev/public/index/qc_report/verifikasicpar/{{ $id }}">CPAR Verification</a><br>
			@endif
		</center>
	</div>
</body>
