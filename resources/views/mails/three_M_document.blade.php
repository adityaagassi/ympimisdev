...
<body>
	<div style="width: 700px;">
		<center>
			...
			<br><br>
			<table style="border: hidden; width: 80%">
				<tr>
					<th style="text-align: left; background-color: rgb(126,86,134); color: white">3M Title : </th>
					<td>{{ $data['tiga_m']->title }}</td>
				</tr>
				<tr>
					<th style="text-align: left; background-color: rgb(126,86,134); color: white">Product Name : </th>
					<td>{{ $data['tiga_m']->product_name }}</td>
				</tr>
				<tr>
					<th style="text-align: left; background-color: rgb(126,86,134); color: white">Proccess Name : </th>
					<td>{{ $data['tiga_m']->proccess_name }}</td>
				</tr>
				<tr>
					<th style="text-align: left; background-color: rgb(126,86,134); color: white">Unit Name : </th>
					<td>{{ $data['tiga_m']->unit }}</td>
				</tr>
				<tr>
					<th style="text-align: left; background-color: rgb(126,86,134); color: white">3M Category : </th>
					<td>{{ $data['tiga_m']->category }}</td>
				</tr>
				<tr>
					<th style="text-align: left; background-color: rgb(126,86,134); color: white">Related Department : </th>
			...
			<table style="border-color: black; width: 80%;">
				<thead style="background-color: rgb(126,86,134);">
					<tr>
						<th colspan="6" style="background-color: #9f84a7">Document List</th>
					</tr>
