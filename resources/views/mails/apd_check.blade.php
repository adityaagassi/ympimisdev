...
<body>
	...
	<div>
		<center>
			...
			<p style="font-size: 18px;">Cek Alat Pelindung Diri (APD) {{ $subsection }} of {{ $leader }} ({{ $department_name }}) {{ $activity_name }} <br>on {{ $monthTitle }} <br> (Last Update: {{ date('d-M-Y H:i:s') }})</p>
			...
			<a href="http://172.17.128.4/mirai/public/index/apd_check/print_apd_check_email/{{ $activity_list_id }}/{{ $month }}">See APD Check Data / Approval Data</a><br>
		</center>
	</div>
</body>
</html>