    ...
    <form role="form">
      <div class="box-body">
        ...
        <div class="row" style="margin-top: 10px">
          ...
          <div class="col-sm-6" align="left">
            <input type="text" class="form-control" id="item_code" placeholder="Kode Item" readonly="">
          </div>
        </div>
        ...
        <div class="row" style="margin-top: 10px">
          ...
          <div class="col-sm-6" align="left">
            <div class="input-group">
                <input type="text" id="item_leadtime" class="form-control" placeholder="Leadtime">
