...
<section class="content-header">
	<h1>
		Purchase Item List <span class="text-purple">????</span>
	</h1>
	<ol class="breadcrumb">
	</ol>
</section>
						...
						<div class="col-md-2">
							<div class="form-group">
								...
								<select class="form-control select2" multiple="multiple" id='uom' data-placeholder="Select UOM" style="width: 100%;">
									<option></option>
									@foreach($uom as $um)
									<option value="{{ $um->uom }}">{{ $um->uom }}</option>
									@endforeach
								</select>
							</div>
						</div>
