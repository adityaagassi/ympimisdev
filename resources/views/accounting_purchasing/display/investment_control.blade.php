...
<section class="content" style="padding-top: 0; padding-bottom: 0">
  <div class="row">
    <div class="col-md-12" style="padding: 1px !important">
        ...
        @if(Auth::user()->role_code == "MIS" || Auth::user()->role_code == "ACC-SPL" || Auth::user()->role_code == "ACC-SPL" || Auth::user()->role_code == "PCH" || Auth::user()->role_code == "PCH-SPL" || Auth::user()->role_code == "JPN-EKS")
        <div class="col-md-2">
