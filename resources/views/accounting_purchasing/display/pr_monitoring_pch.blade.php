    ...
    <div class="col-md-12" style="padding: 1px !important">
      ...
      <div class="col-md-12">
          ...
          <div class="col-md-12" style="padding-right: 0;padding-left: 10px">
              ...
              <table id="tabelmonitor" class="table table-bordered" style="margin-top: 5px; width: 99%">
                <thead style="background-color: rgb(255,255,255); color: rgb(0,0,0); font-size: 12px;font-weight: bold">
                  <tr>
                    <th style="width: 25%; padding: 0;vertical-align: middle;;font-size: 16px;" rowspan="2">No PR</th>
                    <th style="width: 25%; padding: 0;vertical-align: middle;border-left:3px solid #f44336 !important;font-size: 16px;" rowspan="2">Department</th>
                    <th style="width: 50%; padding: 0;vertical-align: middle;border-left:3px solid #f44336 !important;font-size: 16px;" colspan="5">Progress PR</th>
                  </tr>
                  <tr>
                    <th style="width: 10%; padding: 0;border-left:3px solid #f44336 !important;vertical-align: middle;">Staff</th>
                    <th style="width: 10%; padding: 0;vertical-align: middle;">Manager</th>
                    <th style="width: 10%; padding: 0;vertical-align: middle;">DGM</th>
                    <th style="width: 10%; padding: 0;vertical-align: middle;">GM</th>
                    <th style="width: 10%; padding: 0;vertical-align: middle;">Received By Purchasing</th>
                  </tr>
                </thead>
                <tbody id="tabelisi">
                </tbody>
          ...
          <div class="col-md-12">
            ...
            <div class="col-md-12" style="margin-top: 5px;background-color: #000;text-align: center;">
                <span style="font-size: 24px;font-weight: bold;color: white">Outstanding PR Yang Belum PO (Per Item)</span>
            </div>
          ...
          var e = 0;
            ...
            if (value.posisi != "user") {
              ...
              if (value.manager_name != null) {
                ...
                manager = '<a href="'+urlverifikasi+'/'+value.id+'"><span class="label label-danger">None</span></a>'; 
              }
            ...
            table += '<td style="border-left:3px solid #f44336">'+capitalizeFirstLetter(value.department)+'</td>';
            table += '<td style="border-left:3px solid #f44336">'+user+'</td>';  
            table += '<td>'+manager+'</td>';
            table += '<td>'+dgm+'</td>';
            table += '<td>'+gm+'</td>';
            table += '<td>'+pch+'</td>';
