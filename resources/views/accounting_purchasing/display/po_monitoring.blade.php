...
<!--               <div class="col-md-12" style="margin-top: 5px;background-color: #000;text-align: center;">
              ...
              <table id="tabelmonitor" class="table table-bordered" style="margin-top: 5px; width: 99%">
                <thead style="background-color: rgb(255,255,255); color: rgb(0,0,0); font-size: 12px;font-weight: bold">
                  <tr>
                    <th style="width: 10%; padding: 0;vertical-align: middle;;font-size: 16px;background-color: #d84315" rowspan="2">No PO</th>
                    <th style="width: 10%; padding: 0;vertical-align: middle;border-left:3px solid #e64a19 !important;font-size: 16px;background-color: #d84315" rowspan="2">Tanggal PO</th>
                    <th style="width: 10%; padding: 0;vertical-align: middle;border-left:3px solid #e64a19 !important;font-size: 16px;background-color: #d84315" rowspan="2">Supplier</th>
                    <th style="width: 10%; padding: 0;vertical-align: middle;border-left:3px solid #e64a19 !important;font-size: 16px;background-color: #d84315" rowspan="2">Budget</th>
                    <th style="width: 10%; padding: 0;vertical-align: middle;border-left:3px solid #e64a19 !important;font-size: 16px;background-color: #d84315" rowspan="2">Net Payment</th>
                    <th style="width: 50%; padding: 0;vertical-align: middle;border-left:3px solid #e64a19 !important;font-size: 16px;background-color: #d84315" colspan="5">Progress Purchase Order</th>
                  </tr>
                  <tr>
                    <th style="width: 10%; padding: 0;border-left:3px solid #e64a19 !important;vertical-align: middle;font-size: 16px;background-color: #d84315">Buyer</th>
                    <th style="width: 10%; padding: 0;border-left:3px solid #e64a19 !important;vertical-align: middle;font-size: 16px;background-color: #d84315">Manager</th>
                    <th style="width: 10%; padding: 0;border-left:3px solid #e64a19 !important;vertical-align: middle;font-size: 16px;background-color: #d84315">DGM</th>
                    <th style="width: 10%; padding: 0;border-left:3px solid #e64a19 !important;vertical-align: middle;font-size: 16px;background-color: #d84315">GM</th>
                  </tr>
                </thead>
                <tbody id="tabelisi">
                </tbody>
        ...
        if(result.status){
          ...
          $.each(result.datas, function(key, value) {
            ...
            var urlcheck = '{{ url("purchase_order/check/") }}';
              ...
              table += '<td style="border-left:3px solid #000">'+value.tgl_po+'</td>';
              table += '<td style="border-left:3px solid #000">'+value.supplier_name+'</td>';
              table += '<td style="border-left:3px solid #000">'+value.budget_item+'</td>';
              ...
              table += '<td style="border-left:3px solid #000">'+curr+' '+value.amount+'</td>';
              table += '<td style="border-left:3px solid #000">'+buyer+'</td>';  
              table += '<td>'+manager+'</td>';
              table += '<td>'+dgm+'</td>';
              table += '<td>'+gm+'</td>';
