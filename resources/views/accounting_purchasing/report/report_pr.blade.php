	...
	<footer>
		<div class="footer">
			<table style="width: 100%;font-family: arial;border-collapse: collapse;">
				<tr>
					<th colspan="3" style="background-color: #4caf50; border: 1px solid black;font-size: 12px;text-align: center;font-weight: bold">Summary Request</th>
					<th colspan="1"></th>
					...
					<th colspan="1"></th>
					<th colspan="2" style="background-color: #cddc39; border: 1px solid black;font-size: 12px;text-align: center;font-weight: bold">Exchange Rate</th>
				</tr>
				<tr>
					<th colspan="1" style="background-color: #4caf50; border: 1px solid black;font-size: 12px;text-align: center;">Cur</th>
					<th colspan="1" style="background-color: #4caf50; border: 1px solid black;font-size: 12px;text-align: center;">Original Amount</th>
					...
					<td colspan="2" rowspan="2" style="font-size: 12px;font-weight: bold">{{ $rate[0]->currency }} = {{ $rate[0]->rate }} / USD</td>
				...
				<tr>
					...
					<th colspan="1"></th>
					<td colspan="1">&nbsp;</td>
					<td colspan="2" style="font-size: 12px;font-weight: bold">{{ $rate[1]->currency }} = {{ $rate[1]->rate }} / USD</td>
				</tr>		
				<tr>
