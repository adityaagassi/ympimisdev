				...
				<tbody>
					...
					<tr>
						...
						<td colspan="8" style="border: 1px solid black;">
							...
							<rio style="<?php if($inv[0]->applicant_department == "Quality Assurance Department") { echo 'color:blue;font-weight: bold;text-decoration: underline;'; } ?>"> 4. Quality Assurance <img src="{{ public_path() . '/files/jepang/Screenshot_73.jpg' }}" width="20"> </rio>
							...
							<rio style="<?php if($inv[0]->applicant_department == "Woodwind Instrument - Final Assembly (WI-FA) Department" || $inv[0]->applicant_department == "Woodwind Instrument - Welding Process (WI-WP) Department" || $inv[0]->applicant_department == "Woodwind Instrument - Surface Treatment (WI-ST) Department" || $inv[0]->applicant_department == "Educational Instrument (EI) Department" || $inv[0]->applicant_department == "Woodwind Instrument - Key Parts Process (WI-KPP) Department" || $inv[0]->applicant_department == "Woodwind Instrument - Body Parts Process (WI-BPP) Department") { echo 'color:blue;font-weight: bold;text-decoration: underline;'; } ?>"> 7. Production <img src="{{ public_path() . '/files/jepang/Screenshot_76.jpg' }}" width="20"> (<?php if($inv[0]->applicant_department == "Woodwind Instrument - Final Assembly (WI-FA) Department" || $inv[0]->applicant_department == "Woodwind Instrument - Welding Process (WI-WP) Department" || $inv[0]->applicant_department == "Woodwind Instrument - Surface Treatment (WI-ST) Department" || $inv[0]->applicant_department == "Educational Instrument (EI) Department" || $inv[0]->applicant_department == "Woodwind Instrument - Key Parts Process (WI-KPP) Department" || $inv[0]->applicant_department == "Woodwind Instrument - Body Parts Process (WI-BPP) Department") { echo $inv[0]->applicant_department; } ?>)  </rio>
