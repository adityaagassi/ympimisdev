				...
				<tbody>
					...
					<tr>
						...
						<td colspan="8" style="border: 1px solid black;">
							...
							<rio style="<?php if($inv[0]->applicant_department == "Woodwind Instrument - Assembly (WI-A) Department" || $inv[0]->applicant_department == "Woodwind Instrument - Welding-Surface Treatment (WI-WST) Department" || $inv[0]->applicant_department == "Educational Instrument (EI) Department" || $inv[0]->applicant_department == "Woodwind Instrument - Parts Process (WI-PP) Department") { echo 'color:blue;font-weight: bold;text-decoration: underline;'; } ?>"> 7. Production <img src="{{ public_path() . '/files/jepang/Screenshot_76.jpg' }}" width="20"> (<?php if($inv[0]->applicant_department == "Woodwind Instrument - Assembly (WI-A) Department" || $inv[0]->applicant_department == "Woodwind Instrument - Welding-Surface Treatment (WI-WST) Department" || $inv[0]->applicant_department == "Educational Instrument (EI) Department" || $inv[0]->applicant_department == "Woodwind Instrument - Parts Process (WI-PP) Department") { echo $inv[0]->applicant_department; } ?>)  </rio>
