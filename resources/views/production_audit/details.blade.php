				        ...
				        <div class="box-body">
				          <table id="example1" class="table table-bordered table-striped table-hover">
				            ...
				            <tbody>
				              ...
				              <tr>
				                <td>{{$production_audit->product}}</td>
				                <td>{{$production_audit->proses}}</td>
				                <td>
				                  <center>
				                    <a class="btn btn-info" href="{{url('index/production_audit/index/'.$id.'/'.$production_audit->product.'/'.$production_audit->proses)}}">View</a>
