			...
			<div class="box">
				<div class="box-body">
					...
					{{-- <div class="form-group row" align="right">
						<label class="col-xs-5 label-pad"><span class="text-red">*)</span> Harap ditulis dengan huruf cetak</label>
					</div> --}}
					...
					<div class="form-group row" align="right">
						...
						<div class="col-xs-4" align="left">
							<input type="text" class="form-control" id="nama_lengkap" placeholder="Nama Lengkap (Sesuai KTP)" required>
						</div>

						{{-- <label class="col-xs-2 label-pad">Telepon Rumah</label>
						<div class="col-xs-3" align="left">
							<input type="number" class="form-control" id="telepon_rumah" placeholder="Telepon Rumah" required>
						</div> --}}
					</div>
					...
					<div class="form-group row" align="right">
						...
						<div class="col-xs-4" align="left">
							<input type="text" class="form-control" id="employee_id" placeholder="Nomor Induk Karyawan" required>
						</div>

						{{-- <label class="col-xs-2 label-pad">Hand Phone<span class="text-red">*</span></label>
						<div class="col-xs-3" align="left">
							<input type="number" class="form-control" id="hp" placeholder="Nomor Hand Phone (Wajib Diisi)" required>
						</div> --}}
					</div>
					...
					<div class="form-group row" align="right">
						...
						<div class="col-xs-4" align="left">
							<input type="text" class="form-control" id="nik" placeholder="Nomor KTP" required>
						</div>

					{{-- 	<label class="col-xs-2 label-pad">Email<span class="text-red">*</span></label>
						<div class="col-xs-3" align="left">
							<input type="text" class="form-control" id="email" placeholder="Alamat Email (Wajib Diisi)" required>
						</div> --}}
					</div>
					...
					<div class="form-group row" align="right">
						...
						<div class="col-xs-4" align="left">
							<input type="text" class="form-control" id="npwp" placeholder="Nomor NPWP" required>
						</div>

					{{-- 	<label class="col-xs-2 label-pad">Nomor BPJSKES</label>
						<div class="col-xs-3" align="left">
							<input type="text" class="form-control" id="bpjskes" placeholder="Nomor BPJS Kesehatan" required>
						</div> --}}
					</div>
					...
					<div class="form-group row" align="right">
						...
						<div class="col-xs-3" align="left">
							<input type="text" class="form-control" id="faskes" placeholder="Fasilitas Kesehatan" required>
						</div> --}}
					</div>
					...
					<div class="form-group row" align="right">
						...
						<div class="col-xs-3" align="left">
							<div class="input-group date">
								...
								<input type="text" class="form-control datepicker" id="tanggal_lahir" placeholder="Pilih Tanggal Lahir" >
							</div>
						</div>

						{{-- <label class="col-xs-3 label-pad">Nomor BPJSTK</label>
						<div class="col-xs-3" align="left">
							<input type="text" class="form-control" id="bpjstk" placeholder="Nomor BPJS Ketenagakerjaan" required>
						</div> --}}
					</div>					
					...
					<div class="form-group row" align="right">
						...
						<div class="col-xs-3" align="left">
							<select class="form-control select2" data-placeholder="Pilih Status" id="agama" style="width: 100%">
					...
					<div class="form-group row" align="right">
						...
						<div class="col-xs-3" align="left">
							<select class="form-control select2" data-placeholder="Pilih Status" id="status_perkawinan" style="width: 100%">
					...
					<div class="form-group row" align="right">
						...
						<div class="col-xs-5" align="left">
							<textarea id="alamat_asal" class="form-control" rows="3" placecholder="Alamat Asal (Sesuai KTP) ..."></textarea>
						</div>
					</div>
					...
					<div class="form-group row" align="right">
						...
						<div class="col-xs-5" align="left">
							<textarea id="alamat_domisili" class="form-control" rows="3" placecholder="Alamat Domisili (Sekarang)"></textarea>
						</div>
					</div>
					...
					<div class="form-group row" align="right">
						...
						<div class="col-xs-1" align="left" style="padding-left: 0px;">
							<select class="form-control select2" data-placeholder="L/P" id="kelamin_ayah" style="width: 100%">
						...
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="tempat_lahir_ayah" placeholder="Tempat Lahir Ayah">
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<div class="input-group date">
								<div class="input-group-addon bg-green" style="border: none;">
								...
								<input type="text" class="form-control datepicker" id="tanggal_lahir_ayah" placeholder="Tanggal Lahir Ayah" >
							</div>
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="pekerjaan_ayah" placeholder="Pekerjaan Ayah">
						</div>
					</div>
					...
					<div class="form-group row" align="right">
						...
						<div class="col-xs-1" align="left" style="padding-left: 0px;">
							<select class="form-control select2" data-placeholder="L/P" id="kelamin_ibu" style="width: 100%">
								<option style="color:grey;" value="">L/P</option>
								<option value="L">L</option>
								<option value="P">P</option>
							</select>
						...
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="tempat_lahir_ibu" placeholder="Tempat Lahir Ibu">
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<div class="input-group date">
								<div class="input-group-addon bg-green" style="border: none;">
								...
								<input type="text" class="form-control datepicker" id="tanggal_lahir_ibu" placeholder="Tanggal Lahir Ibu" >
							</div>
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
					...
					<div class="form-group row" align="right">
						...
						<div class="col-xs-2" align="left">
							<input type="text" class="form-control" id="nama_saudara1" placeholder="Nama Saudara 1">
						</div>
						<div class="col-xs-1" align="left" style="padding-left: 0px;">
							<select class="form-control select2" data-placeholder="L/P" id="kelamin_saudara1" style="width: 100%">
								<option style="color:grey;" value="">L/P</option>
								<option value="L">L</option>
								<option value="P">P</option>
							</select>
						...
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="tempat_lahir_saudara1" placeholder="Tempat Lahir Saudara 1">
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<div class="input-group date">
								<div class="input-group-addon bg-green" style="border: none;">
								...
								<input type="text" class="form-control datepicker" id="tanggal_lahir_saudara1" placeholder="Tanggal Lahir Saudara 1">
							</div>
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="pekerjaan_saudara1" placeholder="Pekerjaan Saudara 1">
						</div>
					</div>
					...
					<div class="form-group row" align="right">
						...
						<div class="col-xs-2" align="left">
							<input type="text" class="form-control" id="nama_saudara2" placeholder="Nama Saudara 2">
						</div>
						<div class="col-xs-1" align="left" style="padding-left: 0px;">
							<select class="form-control select2" data-placeholder="L/P" id="kelamin_saudara2" style="width: 100%">
								<option style="color:grey;" value="">L/P</option>
								<option value="L">L</option>
								<option value="P">P</option>
							</select>
						...
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="tempat_lahir_saudara2" placeholder="Tempat Lahir Saudara 2">
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<div class="input-group date">
								<div class="input-group-addon bg-green" style="border: none;">
								...
								<input type="text" class="form-control datepicker" id="tanggal_lahir_saudara2" placeholder="Tanggal Lahir Saudara 2">
							</div>
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="pekerjaan_saudara2" placeholder="Pekerjaan Saudara 2">
						</div>
					</div>
					...
					<div class="form-group row" align="right">
						...
						<div class="col-xs-2" align="left">
							<input type="text" class="form-control" id="nama_saudara3" placeholder="Nama Saudara 3">
						</div>
						<div class="col-xs-1" align="left" style="padding-left: 0px;">
							<select class="form-control select2" data-placeholder="L/P" id="kelamin_saudara3" style="width: 100%">
								<option style="color:grey;" value="">L/P</option>
								<option value="L">L</option>
								<option value="P">P</option>
							</select>
						...
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="tempat_lahir_saudara3" placeholder="Tempat Lahir Saudara 3">
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<div class="input-group date">
								<div class="input-group-addon bg-green" style="border: none;">
								...
								<input type="text" class="form-control datepicker" id="tanggal_lahir_saudara3" placeholder="Tanggal Lahir Saudara 3">
							</div>
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="pekerjaan_saudara3" placeholder="Pekerjaan Saudara 3">
						</div>
					</div>
					...
					<div class="form-group row" align="right">
						...
						<div class="col-xs-2" align="left">
							<input type="text" class="form-control" id="nama_saudara4" placeholder="Nama Saudara 4">
						</div>
						<div class="col-xs-1" align="left" style="padding-left: 0px;">
							<select class="form-control select2" data-placeholder="L/P" id="kelamin_saudara4" style="width: 100%">
								<option style="color:grey;" value="">L/P</option>
								<option value="L">L</option>
								<option value="P">P</option>
							</select>
						...
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="tempat_lahir_saudara4" placeholder="Tempat Lahir Saudara 4">
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<div class="input-group date">
								<div class="input-group-addon bg-green" style="border: none;">
								...
								<input type="text" class="form-control datepicker" id="tanggal_lahir_saudara4" placeholder="Tanggal Lahir Saudara 4">
							</div>
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="pekerjaan_saudara4" placeholder="Pekerjaan Saudara 4">
						</div>
					</div>
					...
					<div class="form-group row" align="right">
						...
						<div class="col-xs-2" align="left">
							<input type="text" class="form-control" id="nama_saudara5" placeholder="Nama Saudara 5">
						</div>
						<div class="col-xs-1" align="left" style="padding-left: 0px;">
							<select class="form-control select2" data-placeholder="L/P" id="kelamin_saudara5" style="width: 100%">
								<option style="color:grey;" value="">L/P</option>
								<option value="L">L</option>
								<option value="P">P</option>
							</select>
						...
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="tempat_lahir_saudara5" placeholder="Tempat Lahir Saudara 5">
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<div class="input-group date">
								<div class="input-group-addon bg-green" style="border: none;">
								...
								<input type="text" class="form-control datepicker" id="tanggal_lahir_saudara5" placeholder="Tanggal Lahir Saudara 5">
							</div>
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="pekerjaan_saudara5" placeholder="Pekerjaan Saudara 5">
						</div>
					</div>
					...
					<div class="form-group row" align="right">
						...
						<div class="col-xs-2" align="left">
							<input type="text" class="form-control" id="nama_saudara6" placeholder="Nama Saudara 6">
						</div>
						<div class="col-xs-1" align="left" style="padding-left: 0px;">
							<select class="form-control select2" data-placeholder="L/P" id="kelamin_saudara6" style="width: 100%">
								<option style="color:grey;" value="">L/P</option>
								<option value="L">L</option>
								<option value="P">P</option>
							</select>
						...
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="tempat_lahir_saudara6" placeholder="Tempat Lahir Saudara 6">
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<div class="input-group date">
								<div class="input-group-addon bg-green" style="border: none;">
								...
								<input type="text" class="form-control datepicker" id="tanggal_lahir_saudara6" placeholder="Tanggal Lahir Saudara 6">
							</div>
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="pekerjaan_saudara6" placeholder="Pekerjaan Saudara 6">
						</div>
					</div>
					...
					<div class="form-group row" align="right">
						...
						<div class="col-xs-2" align="left">
							<input type="text" class="form-control" id="nama_saudara7" placeholder="Nama Saudara 7">
						</div>
						<div class="col-xs-1" align="left" style="padding-left: 0px;">
							<select class="form-control select2" data-placeholder="L/P" id="kelamin_saudara7" style="width: 100%">
								<option style="color:grey;" value="">L/P</option>
								<option value="L">L</option>
								<option value="P">P</option>
							</select>
						...
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="tempat_lahir_saudara7" placeholder="Tempat Lahir Saudara 7">
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<div class="input-group date">
								<div class="input-group-addon bg-green" style="border: none;">
								...
								<input type="text" class="form-control datepicker" id="tanggal_lahir_saudara7" placeholder="Tanggal Lahir Saudara 7">
							</div>
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="pekerjaan_saudara7" placeholder="Pekerjaan Saudara 7">
						</div>
					</div>
					...
					<div class="form-group row" align="right">
						...
						<div class="col-xs-2" align="left">
							<input type="text" class="form-control" id="nama_saudara8" placeholder="Nama Saudara 8">
						</div>
						<div class="col-xs-1" align="left" style="padding-left: 0px;">
							<select class="form-control select2" data-placeholder="L/P" id="kelamin_saudara8" style="width: 100%">
								<option style="color:grey;" value="">L/P</option>
								<option value="L">L</option>
								<option value="P">P</option>
							</select>
						...
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="tempat_lahir_saudara8" placeholder="Tempat Lahir Saudara 8">
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<div class="input-group date">
								<div class="input-group-addon bg-green" style="border: none;">
								...
								<input type="text" class="form-control datepicker" id="tanggal_lahir_saudara8" placeholder="Tanggal Lahir Saudara 8">
							</div>
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="pekerjaan_saudara8" placeholder="Pekerjaan Saudara 8">
						</div>
					</div>
					...
					<div class="form-group row" align="right">
						...
						<div class="col-xs-2" align="left">
							<input type="text" class="form-control" id="nama_saudara9" placeholder="Nama Saudara 9">
						</div>
						<div class="col-xs-1" align="left" style="padding-left: 0px;">
							<select class="form-control select2" data-placeholder="L/P" id="kelamin_saudara9" style="width: 100%">
								<option style="color:grey;" value="">L/P</option>
								<option value="L">L</option>
								<option value="P">P</option>
							</select>
						...
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="tempat_lahir_saudara9" placeholder="Tempat Lahir Saudara 9">
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<div class="input-group date">
								<div class="input-group-addon bg-green" style="border: none;">
								...
								<input type="text" class="form-control datepicker" id="tanggal_lahir_saudara9" placeholder="Tanggal Lahir Saudara 9">
							</div>
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="pekerjaan_saudara9" placeholder="Pekerjaan Saudara 9">
						</div>
					</div>
					...
					<div class="form-group row" align="right">
						...
						<div class="col-xs-2" align="left">
							<input type="text" class="form-control" id="nama_saudara10" placeholder="Nama Saudara 10">
						</div>
						<div class="col-xs-1" align="left" style="padding-left: 0px;">
							<select class="form-control select2" data-placeholder="L/P" id="kelamin_saudara10" style="width: 100%">
								<option style="color:grey;" value="">L/P</option>
								<option value="L">L</option>
								<option value="P">P</option>
							</select>
						...
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="tempat_lahir_saudara10" placeholder="Tempat Lahir Saudara 10">
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<div class="input-group date">
								<div class="input-group-addon bg-green" style="border: none;">
								...
								<input type="text" class="form-control datepicker" id="tanggal_lahir_saudara10" placeholder="Tanggal Lahir Saudara 10">
							</div>
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="pekerjaan_saudara10" placeholder="Pekerjaan Saudara 10">
						</div>
					</div>
					...
					<div class="form-group row" align="right">
						...
						<div class="col-xs-2" align="left">
							<input type="text" class="form-control" id="nama_saudara11" placeholder="Nama Saudara 11">
						</div>
						<div class="col-xs-1" align="left" style="padding-left: 0px;">
							<select class="form-control select2" data-placeholder="L/P" id="kelamin_saudara11" style="width: 100%">
								<option style="color:grey;" value="">L/P</option>
								<option value="L">L</option>
								<option value="P">P</option>
							</select>
						...
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="tempat_lahir_saudara11" placeholder="Tempat Lahir Saudara 11">
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<div class="input-group date">
								<div class="input-group-addon bg-green" style="border: none;">
								...
								<input type="text" class="form-control datepicker" id="tanggal_lahir_saudara11" placeholder="Tanggal Lahir Saudara 11">
							</div>
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="pekerjaan_saudara11" placeholder="Pekerjaan Saudara 11">
						</div>
					</div>
					...
					<div class="form-group row" align="right">
						...
						<div class="col-xs-2" align="left">
							<input type="text" class="form-control" id="nama_saudara12" placeholder="Nama Saudara 12">
						</div>
						<div class="col-xs-1" align="left" style="padding-left: 0px;">
							<select class="form-control select2" data-placeholder="L/P" id="kelamin_saudara12" style="width: 100%">
								<option style="color:grey;" value="">L/P</option>
								<option value="L">L</option>
								<option value="P">P</option>
							</select>
						...
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="tempat_lahir_saudara12" placeholder="Tempat Lahir Saudara 12">
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<div class="input-group date">
								<div class="input-group-addon bg-green" style="border: none;">
								...
								<input type="text" class="form-control datepicker" id="tanggal_lahir_saudara12" placeholder="Tanggal Lahir Saudara 12">
							</div>
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="pekerjaan_saudara12" placeholder="Pekerjaan Saudara 12">
						</div>
					</div>
					...
					<div class="form-group row" align="right">
						...
						<div class="col-xs-2" align="left">
							<input type="text" class="form-control" id="nama_pasangan" placeholder="Nama Pasangan">
						</div>
						<div class="col-xs-1" align="left" style="padding-left: 0px;">
							<select class="form-control select2" data-placeholder="L/P" id="kelamin_pasangan" style="width: 100%">
								<option style="color:grey;" value="">L/P</option>
								<option value="L">L</option>
								<option value="P">P</option>
							</select>
						...
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="tempat_lahir_pasangan" placeholder="Tempat Lahir Pasangan">
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<div class="input-group date">
								<div class="input-group-addon bg-green" style="border: none;">
								...
								<input type="text" class="form-control datepicker" id="tanggal_lahir_pasangan" placeholder="Tanggal Lahir Pasangan" >
							</div>
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="pekerjaan_pasangan" placeholder="Pekerjaan Pasangan">
						</div>
					</div>
					...
					<div class="form-group row" align="right">
						...
						<div class="col-xs-2" align="left">
							<input type="text" class="form-control" id="nama_anak1" placeholder="Nama Anak 1">
						</div>
						<div class="col-xs-1" align="left" style="padding-left: 0px;">
							<select class="form-control select2" data-placeholder="L/P" id="kelamin_anak1" style="width: 100%">
								<option style="color:grey;" value="">L/P</option>
								<option value="L">L</option>
								<option value="P">P</option>
							</select>
						...
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="tempat_lahir_anak1" placeholder="Tempat Lahir Anak 1">
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<div class="input-group date">
								<div class="input-group-addon bg-green" style="border: none;">
								...
								<input type="text" class="form-control datepicker" id="tanggal_lahir_anak1" placeholder="Tanggal Lahir Anak 1" >
							</div>
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="pekerjaan_anak1" placeholder="Pekerjaan Anak 1">
						</div>
					</div>
					...
					<div class="form-group row" align="right">
						...
						<div class="col-xs-2" align="left">
							<input type="text" class="form-control" id="nama_anak2" placeholder="Nama Anak 2">
						</div>
						<div class="col-xs-1" align="left" style="padding-left: 0px;">
							<select class="form-control select2" data-placeholder="L/P" id="kelamin_anak2" style="width: 100%">
								<option style="color:grey;" value="">L/P</option>
								<option value="L">L</option>
								<option value="P">P</option>
							</select>
						...
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="tempat_lahir_anak2" placeholder="Tempat Lahir Anak 2">
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<div class="input-group date">
								<div class="input-group-addon bg-green" style="border: none;">
								...
								<input type="text" class="form-control datepicker" id="tanggal_lahir_anak2" placeholder="Tanggal Lahir Anak 2" >
							</div>
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="pekerjaan_anak2" placeholder="Pekerjaan Anak 2">
						</div>
					</div>
					...
					<div class="form-group row" align="right">
						...
						<div class="col-xs-2" align="left">
							<input type="text" class="form-control" id="nama_anak3" placeholder="Nama Anak 3">
						</div>
						<div class="col-xs-1" align="left" style="padding-left: 0px;">
							<select class="form-control select2" data-placeholder="L/P" id="kelamin_anak3" style="width: 100%">
								<option style="color:grey;" value="">L/P</option>
								<option value="L">L</option>
								<option value="P">P</option>
							</select>
						...
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="tempat_lahir_anak3" placeholder="Tempat Lahir Anak 3">
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<div class="input-group date">
								<div class="input-group-addon bg-green" style="border: none;">
								...
								<input type="text" class="form-control datepicker" id="tanggal_lahir_anak3" placeholder="Tanggal Lahir Anak 3" >
							</div>
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="pekerjaan_anak3" placeholder="Pekerjaan Anak 3">
						</div>
					</div>
					...
					<div class="form-group row" align="right">
						...
						<div class="col-xs-2" align="left">
							<input type="text" class="form-control" id="nama_anak4" placeholder="Nama Anak 4">
						</div>
						<div class="col-xs-1" align="left" style="padding-left: 0px;">
							<select class="form-control select2" data-placeholder="L/P" id="kelamin_anak4" style="width: 100%">
								<option style="color:grey;" value="">L/P</option>
								<option value="L">L</option>
								<option value="P">P</option>
							</select>
						...
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="tempat_lahir_anak4" placeholder="Tempat Lahir Anak 4">
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<div class="input-group date">
								<div class="input-group-addon bg-green" style="border: none;">
								...
								<input type="text" class="form-control datepicker" id="tanggal_lahir_anak4" placeholder="Tanggal Lahir Anak 4" >
							</div>
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="pekerjaan_anak4" placeholder="Pekerjaan Anak 4">
						</div>
					</div>
					...
					<div class="form-group row" align="right">
						...
						<div class="col-xs-2" align="left">
							<input type="text" class="form-control" id="nama_anak5" placeholder="Nama Anak 5">
						</div>
						<div class="col-xs-1" align="left" style="padding-left: 0px;">
							<select class="form-control select2" data-placeholder="L/P" id="kelamin_anak5" style="width: 100%">
								<option style="color:grey;" value="">L/P</option>
								<option value="L">L</option>
								<option value="P">P</option>
							</select>
						...
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="tempat_lahir_anak5" placeholder="Tempat Lahir Anak 5">
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<div class="input-group date">
								<div class="input-group-addon bg-green" style="border: none;">
								...
								<input type="text" class="form-control datepicker" id="tanggal_lahir_anak5" placeholder="Tanggal Lahir Anak 5" >
							</div>
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="pekerjaan_anak5" placeholder="Pekerjaan Anak 5">
						</div>
					</div>
					...
					<div class="form-group row" align="right">
						...
						<div class="col-xs-2" align="left">
							<input type="text" class="form-control" id="nama_anak6" placeholder="Nama Anak 6">
						</div>
						<div class="col-xs-1" align="left" style="padding-left: 0px;">
							<select class="form-control select2" data-placeholder="L/P" id="kelamin_anak6" style="width: 100%">
								<option style="color:grey;" value="">L/P</option>
								<option value="L">L</option>
								<option value="P">P</option>
							</select>
						...
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="tempat_lahir_anak6" placeholder="Tempat Lahir Anak 6">
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<div class="input-group date">
								<div class="input-group-addon bg-green" style="border: none;">
								...
								<input type="text" class="form-control datepicker" id="tanggal_lahir_anak6" placeholder="Tanggal Lahir Anak 6" >
							</div>
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="pekerjaan_anak6" placeholder="Pekerjaan Anak 6">
						</div>
					</div>
					...
					<div class="form-group row" align="right">
						...
						<div class="col-xs-2" align="left">
							<input type="text" class="form-control" id="nama_anak7" placeholder="Nama Anak 7">
						</div>
						<div class="col-xs-1" align="left" style="padding-left: 0px;">
							<select class="form-control select2" data-placeholder="L/P" id="kelamin_anak7" style="width: 100%">
								<option style="color:grey;" value="">L/P</option>
								<option value="L">L</option>
								<option value="P">P</option>
							</select>
						...
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="tempat_lahir_anak7" placeholder="Tempat Lahir Anak 7">
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<div class="input-group date">
								<div class="input-group-addon bg-green" style="border: none;">
								...
								<input type="text" class="form-control datepicker" id="tanggal_lahir_anak7" placeholder="Tanggal Lahir Anak 7" >
							</div>
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="pekerjaan_anak7" placeholder="Pekerjaan Anak 7">
						</div>
					</div>
					...
					<div class="form-group row" align="right">
						...
						<div class="col-xs-2" align="left">
							<input type="text" class="form-control" id="sd" placeholder="Nama Lembaga Pendidikan">
						</div>
						...
						<div class="col-xs-2" align="left">
							<input type="number" class="form-control yearpicker" id="sd_masuk" placeholder="Tahun Masuk">
						</div>
						
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="number" class="form-control yearpicker" id="sd_lulus" placeholder="Tahun Lulus">
						</div>
					</div>
					...
					<div class="form-group row" align="right">
						...
						<div class="col-xs-2" align="left">
							<input type="text" class="form-control" id="smp" placeholder="Nama Lembaga Pendidikan">
						</div>
						...
						<div class="col-xs-2" align="left">
							<input type="number" class="form-control yearpicker" id="smp_masuk" placeholder="Tahun Masuk">
						</div>
						
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="number" class="form-control yearpicker" id="smp_lulus" placeholder="Tahun Lulus">
						</div>
					</div>
					...
					<div class="form-group row" align="right">
						...
						<div class="col-xs-2" align="left">
							<input type="text" class="form-control" id="sma" placeholder="Nama Lembaga Pendidikan">
						</div>

						<div class="col-xs-2" align="left">
							<input type="text" class="form-control" id="sma_jurusan" placeholder="Jurusan">
						</div>

						<div class="col-xs-2" align="left">
							<input type="number" class="form-control yearpicker" id="sma_masuk" placeholder="Tahun Masuk">
						</div>
						
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="number" class="form-control yearpicker" id="sma_lulus" placeholder="Tahun Lulus">
						</div>
					</div>
					...
					<div class="form-group row" align="right">
						...
						<div class="col-xs-2" align="left">
							<input type="text" class="form-control" id="s1" placeholder="Nama Lembaga Pendidikan">
						</div>

						<div class="col-xs-2" align="left">
							<input type="text" class="form-control" id="s1_jurusan" placeholder="Jurusan">
						</div>

						<div class="col-xs-2" align="left">
							<input type="number" class="form-control yearpicker" id="s1_masuk" placeholder="Tahun Masuk">
						</div>
						
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="number" class="form-control yearpicker" id="s1_lulus" placeholder="Tahun Lulus">
						</div>
					</div>
					...
					<div class="form-group row" align="right">
						...
						<div class="col-xs-2" align="left">
							<input type="text" class="form-control" id="s2" placeholder="Nama Lembaga Pendidikan">
						</div>

						<div class="col-xs-2" align="left">
							<input type="text" class="form-control" id="s2_jurusan" placeholder="Jurusan">
						</div>

						<div class="col-xs-2" align="left">
							<input type="number" class="form-control yearpicker" id="s2_masuk" placeholder="Tahun Masuk">
						</div>
						
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="number" class="form-control yearpicker" id="s2_lulus" placeholder="Tahun Lulus">
						</div>
					</div>
					...
					<div class="form-group row" align="right">
						...
						<div class="col-xs-2" align="left">
							<input type="text" class="form-control" id="s3" placeholder="Nama Lembaga Pendidikan">
						</div>

						<div class="col-xs-2" align="left">
							<input type="text" class="form-control" id="s3_jurusan" placeholder="Jurusan">
						</div>

						<div class="col-xs-2" align="left">
							<input type="number" class="form-control yearpicker" id="s3_masuk" placeholder="Tahun Masuk">
						</div>
						
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="number" class="form-control yearpicker" id="s3_lulus" placeholder="Tahun Lulus">
						</div>
					</div>
					...
					<div class="form-group row" align="right">
						<div class="col-xs-2 col-xs-offset-2" align="left">
							<input type="text" class="form-control" id="nama_darurat1" placeholder="Nama">
						</div>
						<div class="col-xs-2" align="left">
							<input type="number" class="form-control" id="telp_darurat1" placeholder="Nomor Telepon">
						</div>						
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="pekerjaan_darurat1" placeholder="Pekerjaan">
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="hubungan_darurat1" placeholder="Hubungan">
						</div>
					</div>
					...
					<div class="form-group row" align="right">
						<div class="col-xs-2 col-xs-offset-2" align="left">
							<input type="text" class="form-control" id="nama_darurat2" placeholder="Nama">
						</div>
						<div class="col-xs-2" align="left">
							<input type="number" class="form-control" id="telp_darurat2" placeholder="Nomor Telepon">
						</div>						
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="pekerjaan_darurat2" placeholder="Pekerjaan">
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="hubungan_darurat2" placeholder="Hubungan">
						</div>
					</div>
					...
					<div class="form-group row" align="right">
						<div class="col-xs-2 col-xs-offset-2" align="left">
							<input type="text" class="form-control" id="nama_darurat3" placeholder="Nama">
						</div>
						<div class="col-xs-2" align="left">
							<input type="number" class="form-control" id="telp_darurat3" placeholder="Nomor Telepon">
						</div>						
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="pekerjaan_darurat3" placeholder="Pekerjaan">
						</div>
						<div class="col-xs-2" align="left" style="padding-left: 0px;">
							<input type="text" class="form-control" id="hubungan_darurat3" placeholder="Hubungan">
						</div>
					</div>

					<div class="form-group row" align="center" style="margin-top: 5%; margin-bottom: 10%;">
						<div class="col-xs-6 col-xs-offset-3">
							<button style="margin-right: 10%;" class="btn btn-danger" onclick="cancel()"><i class="fa fa-close"></i> CANCEL</button>
							<button class="btn btn-success" onclick="submitForm()"><i class="fa fa-save"></i> SIMPAN</button>
						</div>
					</div>
