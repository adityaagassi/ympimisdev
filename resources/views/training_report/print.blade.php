    ...
    {{-- <div class="box-header with-border">
      ...
      <div class="box-body">
		...
		<table class="table" id="table2">
			<tbody>
				<tr>
					<td width="10%" style="border-top: 1px solid black;padding-top:50px">Tanggal</td>
					<td width="15%" style="border-top: 1px solid black;text-align: right;padding-top:50px">:</td>
					<td width="50%" style="border-top: 1px solid black;padding-top:50px">{{ $training->date }}</td>
				</tr>
				<tr>
