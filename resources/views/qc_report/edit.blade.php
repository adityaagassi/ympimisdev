...
<script>
  $(document).ready(function() {
    ...
    if (document.getElementById("kategori").value == "Eksternal") {
      ...
      $addeksternal = '<div class="form-group row" align="left"><div class="col-sm-6"></div><label class="col-sm-1">Kategori Komplain<span class="text-red">*</span></label><div class="col-sm-5" align="left"><select class="form-control select2" name="kategori_komplain" style="width: 100%;" data-placeholder="Pilih Kategori Komplain"><?php if($cpars->kategori_komplain == "KD Parts") { ?><option value="KD Parts" selected>KD Parts</option><option value="FG">Finished Goods</option><option value="NG Jelas">NG Jelas</option><option value="Claim Rate">Claim Rate</option> <?php } else if ($cpars->kategori_komplain == "FG") { ?> <option value="KD Parts">KD Parts</option><option value="FG" selected>Finished Goods</option><option value="NG Jelas">NG Jelas</option><option value="Claim Rate">Claim Rate</option><?php } else if ($cpars->kategori_komplain == "NG Jelas") { ?> <option value="KD Parts">KD Parts</option><option value="FG">Finished Goods</option><option value="NG Jelas" selected>NG Jelas</option><option value="Claim Rate">Claim Rate</option><?php } else if ($cpars->kategori_komplain == "Claim Rate") { ?><option value="KD Parts">KD Parts</option><option value="FG">Finished Goods</option><option value="NG Jelas">NG Jelas</option><option value="Claim Rate" selected>Claim Rate</option><?php } else { ?> <option></option><option value="KD Parts">KD Parts</option><option value="FG">Finished Goods</option><option value="NG Jelas">NG Jelas</option><option value="Claim Rate">Claim Rate</option><?php } ?>';
