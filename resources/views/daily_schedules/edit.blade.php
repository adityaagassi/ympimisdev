...
<section class="content">
  ...
  <div class="box box-primary">
    ...
    <form role="form" method="post" action="{{url('edit/daily_schedule', $daily_schedule->id)}}">
      <div class="box-body">
        ...
        <div class="form-group row" align="right">
          ...
          <div class="col-sm-4" align="left">
            <select class="form-control select2" name="material_number" style="width: 100%;" data-placeholder="Choose a Material Number..." required>
              ...
              @if($daily_schedule->material_number == $material->material_number)
        ...
        <div class="form-group row" align="right">
          ...
          <div class="col-sm-4" align="left">
            <select class="form-control select2" name="destination_code" style="width: 100%;" data-placeholder="Choose a Destination Code..." required>
              ...
              @if($daily_schedule->destination_code == $destination->destination_code)
        ...
        <div class="form-group row" align="right">
          ...
          <div class="col-sm-4">
           <div class="input-group">
            <input type="date" class="form-control" name="due_date" placeholder="Enter Due Date" value="{{ $daily_schedule->due_date }}" required>
    ...
    <div class="form-group row" align="right">
      ...
      <div class="col-sm-4">
        <div class="input-group">
          <input min="1" type="number" class="form-control" name="quantity" placeholder="Enter Quantity" value="{{ $daily_schedule->quantity }}" required>
    ...
    <div class="box-footer form-group row">
      ...
      <div class="btn-group">
        <a class="btn btn-danger col-sm-14" href="{{ url('index/daily_schedule') }}">Cancel</a>
      </div>
      <div class="btn-group">
