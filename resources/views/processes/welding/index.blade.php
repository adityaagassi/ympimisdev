...
<section class="content">
	<div class="row">
		...
		<div class="col-xs-4" style="text-align: center;">
			...
			<a href="{{ url("index/welding/op_analysis?tanggal=&location=&group=") }}" class="btn btn-default btn-block" style="font-size: 24px; border-color: red;">Welding OP Analysis</a>
