...
<section class="content-header">
	<h1>
		Seasoning Flute<span class="text-purple"> ??? </span>
...
<script>
	...
	function scanSerialNumber(){
		if($('#manPower').val() > 0){
			...
			$.post('{{ url("input/process_assy_fl_3") }}', data, function(result, status, xhr){
				console.log(status);
				console.log(result);
				console.log(xhr);
				if(xhr.status == 200){
	...
	function fillChartEfficiency(){
		...
		$.get('{{ url("fetch/process_assy_fl_3/efficiencyChart") }}', function(result, status, xhr){
			console.log(status);
			console.log(result);
			console.log(xhr);
			if(xhr.status == 200){
	...
	function fillChartActual(){
		$.get('{{ url("fetch/process_assy_fl_3/actualChart") }}', function(result, status, xhr){
			console.log(status);
			console.log(result);
			console.log(xhr);
			if(xhr.status == 200){
	...
	function fillChartStock(){
		$.get('{{ url("fetch/process_assy_fl_3/stockChart") }}', function(result, status, xhr){
			console.log(status);
			console.log(result);
			console.log(xhr);
			if(xhr.status==200){
