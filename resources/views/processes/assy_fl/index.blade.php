...
<section class="content">
	<div class="row">
		<div class="col-xs-4" style="text-align: center;">
			...
			<a href="{{ url("index/assembly/flute_stamp") }}" class="btn btn-default btn-block" style="font-size: 2vw; border-color: green;">Stamp <b><i>IoT</i></b> New</a>
			...
			<a href="{{ url("index/middle/buffing_target/assy_fl") }}" class="btn btn-default btn-block" style="font-size: 2vw; border-color: green;">Assembly Flute Target</a>
