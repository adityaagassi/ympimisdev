		...
		<div class="col-xs-6" style="padding-right: 0; padding-left: 0">
			<div>
				<table class="table table-bordered" style="width: 100%; margin-bottom: 5px;">
					<thead>
						<tr>
							<th style="width:15%; background-color: rgb(220,220,220); text-align: center; color: black; padding:0;font-size: 20px;" colspan="2">Operator Kensa</th>
						</tr>
					</thead>
					<tbody>
						<tr>
				...
				<table style="width: 100%;" border="1">
					<tbody>
						<tr>
							...
							<td id="model" style="width: 4%; font-size: 25px; font-weight: bold; background-color: rgb(100,100,100); color: yellow; border: 1px solid black" colspan="2"></td>
							<td style="width: 1%; font-weight: bold; font-size: 25px; background-color: rgb(220,220,220);">Key</td>
							<td id="key" style="width: 4%; font-weight: bold; font-size: 25px; background-color: rgb(100,100,100); color: yellow; border: 1px solid black"></td>
						...
						<tr>
							<td colspan="2" style="font-weight: bold; background-color: rgb(220,220,220); font-size: 25px;">Operator Buffing</td>
							<td colspan="3" style="font-weight: bold; font-size: 25px; background-color: rgb(100,100,100); color: yellow; border: 1px solid black" id="opbuffing"></td>
						</tr>
					</tbody>
				</table>
			</div>
