...
<section class="content-header">
	<h1>
		Surface Treatment<span class="text-purple"> ??</span>
...
<section class="content">
	<div class="row">
		<div class="col-xs-4" style="text-align: center;">
			...
			<a href="{{ url("index/middle/request/Clarinet") }}" class="btn btn-default btn-block" style="font-size: 24px; border-color: green;">Request Clarinet</a>
		</div>
