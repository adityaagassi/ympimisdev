...
<section class="content-header">
	<h1>
		Clarinet Subassy-Assembly WIP<span class="text-purple"> FL仮組・組立の仕掛品</span>
...
<section class="content">
	<div class="row">
		<div class="col-xs-4" style="text-align: center;">
			...
			<a href="{{ url("index/process_stamp_cl_1") }}" class="btn btn-default btn-block" style="font-size: 2vw; border-color: green;">Stamp <b><i>IoT</i></b></a>
		...
		<div class="col-xs-4" style="text-align: center; color: red;">
			<span style="font-size: 3vw;"><i class="fa fa-angle-double-down"></i> NG <i class="fa fa-angle-double-down"></i></span>
			 <a href="{{ url("index/repairCl") }}" class="btn btn-default btn-block" style="font-size: 2vw; border-color: red;">Return/Repair</a> 
		</div>
