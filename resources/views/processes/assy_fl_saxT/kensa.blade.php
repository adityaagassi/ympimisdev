		...
		<div class="col-xs-6" style="padding-right: 0; padding-left: 0">
			...
			<div style="padding-top: 5px;">
				<table style="width: 100%;" border="1">
					<thead>
						<tr>
							<td style="text-align: center; width: 2%; font-weight: bold; font-size: 25px; background-color: rgb(220,220,220);">OP Kensa</td>
							<td colspan="3" id="op_kensa" style="text-align: center; width: 4%; font-size: 25px; font-weight: bold; background-color: rgb(100,100,100); color: yellow;"></td>
						</tr>
					</thead>
					<tbody>
						<tr>
