						...
						<div class="col-xs-12">
							...
							<div class="col-xs-4" style="padding-top:10px">
								...
								<table class="table" id="tablemiddle">
									...
									<tbody>
										<tr>
											<td width="50%" onclick="getData2(14)">
												<center>
													<button class="btn btn-info" style="width: 100%;height: 40px;font-size: 1.5vw;font-weight: bold;">
														1-4
													</button>
											...
											<td width="50%" onclick="getData2(15)">
												<center>
													<button class="btn btn-info" style="width: 100%;height: 40px;font-size: 1.5vw;font-weight: bold;">
														5-8
													</button>
										...
										<tr>
											<td width="50%" onclick="getData2(16)">
												<center>
													<button class="btn btn-info" style="width: 100%;height: 40px;font-size: 1.5vw;font-weight: bold;">
														9-12
													</button>
											...
											<td width="50%" onclick="getData2(17)">
												<center>
													<button class="btn btn-info" style="width: 100%;height: 40px;font-size: 1.5vw;font-weight: bold;">
														13-16
													</button>
...
<script>
	...
	function push_pull(id) {
		var batas_bawah = '{{ $batas_bawah_hm }}';
		var batas_atas = '{{ $batas_atas_hm }}';
		// console.log(id);
		if(id.length == 13){
