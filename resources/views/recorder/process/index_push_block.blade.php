		...
		<div class="col-xs-6">
			...
			<div class="row">
				...
				<div class="col-xs-12">
					<div class="row">
						<div class="col-xs-12">
							<input style="font-size: 20px; height: 30px; text-align: center;" id="check_date" type="text" class="form-control" readonly value="{{ date('Y-m-d') }}">
						</div>
					</div>
				</div>
			</div>
						...
						<table class="table table-hover table-striped table-bordered" id="tableResume1">
							<thead>
								<tr>
									...
									<th style="width: 2%;font-size: 12px;color:white;background-color:#605ca8"><center>Block</center></th>
	...
	function konfirmasi(){
		...
		for(var i = 1; i <= 4; i++){
			for(var j = 1; j <= 4; j++){
				...
				if($("#push_pull_"+$("#head_"+[j]).val()+"_"+$("#block_"+[i]).val()).val() == ''){
					status_false++;
				}
			}
		}
		for(var k = 5; k <= 8; k++){
			for(var l = 1; l <= 4; l++){
				...
				if($("#push_pull_"+$("#head_"+[l]).val()+"_"+$("#block_"+[k]).val()).val() == ''){
					status_false++;
				}
			}
		}
	...
	function itemresume1(head_id,block){
		...
		$.get('{{ url("index/fetchResume") }}', data, function(result, status, xhr){
			...
			// $.each(result.datas, function(key, value) {
				...
				tableData += '<tr>';
				tableData += '<td style="text-align:right;background-color:#605ca8;color:white">'+ 1 +'</td>';
				...
				tableData += '</tr>';
				tableData += '<tr>';
				tableData += '<td style="text-align:right;background-color:#605ca8;color:white">'+ 2 +'</td>';
				...
				tableData += '</tr>';
				tableData += '<tr>';
				tableData += '<td style="text-align:right;background-color:#605ca8;color:white">'+ 3 +'</td>';
				...
				tableData += '</tr>';
				tableData += '<tr>';
				tableData += '<td style="text-align:right;background-color:#605ca8;color:white">'+ 4 +'</td>';
