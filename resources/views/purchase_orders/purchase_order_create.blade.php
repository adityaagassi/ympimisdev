          ...
          <div class="col-xs-6">
               <div class="box box-solid">
                    <div class="box-header">
                         <h3 class="box-title">By Selected PO<span class="text-purple"> japanese</span></h3>
                    </div>
                    <div class="box-body">
                         <div class="row">
                              <div class="col-xs-6">
                         ...
                         <div class="col-xs-12">
                              <div class="col-md-4 col-md-offset-2">
                                   <div class="form-group">
                                        ...
                                        <select class="form-control select2" multiple="multiple" id='pgr' data-placeholder="Select Purchase Group" style="width: 100%;">
                                             <option></option>
                                             @foreach($pgrs as $pgr)
                              ...
                              <div class="col-md-4 col-md-offset-2">
                                   <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                             ...
                                             <input type="text" class="form-control pull-right" id="orderfrom">
                                        </div>
                                   </div>
                              </div>
                              <div class="col-md-4">
                                   <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                             ...
                                             <input type="text" class="form-control pull-right" id="orderto">
                                        </div>
                                   </div>
                              </div>
                         </div>
                              ...
                              <div class="col-md-4 col-md-offset-2">
                                   <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                             ...
                                             <input type="text" class="form-control pull-right" id="delivfrom">
                                        </div>
                                   </div>
                              </div>
                              <div class="col-md-4">
                                   <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                             ...
                                             <input type="text" class="form-control pull-right" id="delivto">
                                        </div>
                                   </div>
                              </div>
                         </div>
                         <div class="col-xs-12">
                              <div class="col-md-4 col-md-offset-2">
                                   <div class="form-group">
                                        ...
                                        <input id="docNoTags" type="text" class="form-control tags"/>
                                   </div>
                              </div>
                              <div class="col-md-4">
                                   <div class="form-group">
                                        ...
                                        <input id="materialTags" type="text" class="form-control tags"/>
                                   </div>
                              </div>
                         </div>
                         <div class="col-xs-12">
                              <div class="col-md-4 col-md-offset-2">
                                   <div class="form-group">
                                        ...
                                        <input id="itemTags" type="text" class="form-control tags"/>
                                   </div>
                              </div>
                              <div class="col-md-4">
                                   <div class="form-group">
                                        ...
                                        <input id="vendorTags" type="text" class="form-control tags"/>
                                   </div>
                              </div>
                         </div> 
                         <div class="col-xs-12">       
                              <div class="col-md-4 col-md-offset-6">
                                   <div class="form-group pull-right">
                                        ...
                                        <a href="javascript:void(0)" onClick="exportPoList()" class="btn btn-success"><i class="fa fa-download"></i> Excel</a>
