	...
	<div class="row" style="margin-left: 1%; margin-right: 1%;">
			...
			<div class="col-xs-12" style="padding-right: 0; padding-left: 0; margin-bottom: 2%;">
				<div class="input-group input-group-lg">
					...
					<span class="input-group-btn">
						<button href="javascript:void(0)" class="btn btn-success btn-flat" data-toggle="modal" data-target="#scanModal"><i class="fa fa-camera"></i> Scan QR</button>
					</span>
				</div>
			</div>
		...
		<div class="col-xs-5" style="margin-top: 5%;">
			<div class="col-xs-12">
				<div class="form-group row" align="right">
					...
					<div class="col-xs-6" align="right">
						<input type="text" style="font-size:28px; height: 45px;" onchange="changeVal()" class="form-control numpad" placeholder="INPUT LOT HERE" id="lot">
					</div>
				</div>	
			</div>
			<div class="col-xs-12">	
				<div class="form-group row" align="right">
					...
					<div class="col-xs-6 col-xs-offset-3" align="right">
						<input type="text" style="font-size:28px; height: 45px;" onchange="changeVal()" class="form-control numpad" placeholder="INPUT Z1 HERE" id="z1">
					</div>
				</div>
			</div>
			<div class="col-xs-12">		
			...
			<div class="col-xs-12" align="right">
				<div class="input-group input-group-lg">
					<button type="button" style="font-size:30px; height: 45px; font-weight: bold; padding-top: 0px; padding-bottom: 0px;" onclick="canc()" class="btn btn-danger">&nbsp;Cancel&nbsp;</button>

					<button type="button" style="font-size:30px; height: 45px; font-weight: bold; padding-top: 0px; padding-bottom: 0px;" onclick="save()" class="btn btn-success">&nbsp;<i class="fa fa-save"></i> &nbsp;Save&nbsp;</button>
				</div>
			</div>
		</div>
