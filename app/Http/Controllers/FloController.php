    ...
    public function reprint_flo(Request $request)
    {
        ...
        if($flo != null){
            try {
                ...
                return redirect('/index/flo_sn')->with('status', 'FLO has been reprinted.')->with('page', 'FLO Serial Number');
            } 
            catch(\Exception $e){
            ...
            return redirect('/index/flo_sn')->with('error', 'FLO number '. $request->get('flo_number') . 'not found.');
        }
