...
class GeneralController extends Controller{
	...
	public function indexOnlineTransportation(){
		...
		if(Auth::user()->role_code != 'MIS' && Auth::user()->role_code != 'S' && substr($employee->grade_code, 0, 1) != 'L' && substr($employee->grade_code, 0, 1) != 'M' && Auth::user()->username != 'pi0603019' && Auth::user()->username != 'pi9902018'){
			return view('404');
		}
