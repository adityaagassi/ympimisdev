...
{
	use SoftDeletes;
	public $table = "detail_checksheet";
    //
	protected $fillable = [
		'diff','confirm','id_checkSheet','countainer_number', 'gmc', 'goods', 'marking', 'package_qty', 'package_set', 'qty_qty', 'qty_set', 'created_by', 'destination','invoice'
	];
