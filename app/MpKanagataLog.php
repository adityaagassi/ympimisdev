...
class MpKanagataLog extends Model
{
	...
	protected $fillable = [
		'date','pic','shift','product','shift','material_number','process','machine','punch_number','die_number','punch_value','die_value','punch_total','die_total','start_time','end_time','note','punch_status','die_status','created_by'
	];
