...
class UploadTransferKD extends Command
{
    ...
    public function handle()
    {
        ...
        ->select('plant', 'material_number', 'issue_plant', 'issue_location', 'receive_plant', 'receive_location', db::raw('sum(quantity) as quantity'), 'cost_center', 'gl_account', db::raw('date(created_at) as date', 'transaction_code', 'movement_type', 'reason_code'))
